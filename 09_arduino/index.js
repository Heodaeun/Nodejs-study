...
const port = new SerialPort('COM5'); //Connect serial port to port COM5. Because my Arduino Board is connected on port COM5. See yours on Arduino IDE -> Tools -> Port
